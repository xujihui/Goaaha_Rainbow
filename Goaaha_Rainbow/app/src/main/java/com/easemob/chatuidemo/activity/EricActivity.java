 ...
 */
public class EricActivity extends Activity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_scan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(EricActivity.this,CaptureActivity.class);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.czh_back:
                ...
                Utils.flag = 5;
                Intent intent = new Intent();
                intent.setClass(EricActivity.this, MainActivity.class);
                startActivity(intent);
                break;
        }
    }
